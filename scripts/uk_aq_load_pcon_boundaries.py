...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--code-field", default="pcon_code", help="GeoJSON property for PCON code.")
    parser.add_argument("--name-field", default="pcon_name", help="GeoJSON property for PCON name.")
...
def main() -> int:
    ...
    for batch in chunked(rows, max(1, args.batch_size)):
        client.table("pcon_boundaries").upsert(batch, on_conflict="pcon_code,pcon_version").execute()
