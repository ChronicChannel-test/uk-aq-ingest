...
Examples:
  python scripts/uk_aq_defra_compare.py
  python scripts/uk_aq_defra_compare.py --station-id BR11 --tolerance 1.5
  python scripts/uk_aq_defra_compare.py --defra-url "https://uk-air.defra.gov.uk/data/site-data?f_site_id=BR11&view=last_hour"
"""
...
def fetch_defra_rows(url: str, timeout: int = 30) -> List[PollutantRow]:
    headers = {
        "User-Agent": "Mozilla/5.0 (uk_aq_defra_compare)"
    }
