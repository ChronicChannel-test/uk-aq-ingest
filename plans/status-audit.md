...
- History RPC expects `status_id` (smallint) in input rows, not `status`:
  - `/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:159`
  - `/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:165`
...
- History DB: not meaningfully persisted to `status_id`.
  ...
  - History RPC input uses `status_id` only (`/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:165`)
...
- History DB: `status_id` remains null (same global mismatch).
  ...
  - History upsert RPC call (`workers/uk_aq_sensorcommunity_cloud_run/index.mjs:1322`) expects `status_id` in SQL (`/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:165`).
...
- History DB:
  ...
  - `uk_aq_history.observations.status_id` not mapped/populated (SQL expects `status_id`, `/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:165`).
...
- History DB:
  ...
  - `status_id` not mapped/populated (SQL expects `status_id`, `/Users/mikehinford/Library/CloudStorage/Dropbox/Projects/CIC Website/CIC Air Quality Networks/CIC-Test-UK-AQ-Schema/CIC-test-uk-aq-schema/schemas/history_db/history_db_dualwrite_bootstrap.sql:165`).
...
- But schema/RPC changes must be coordinated: if you drop/alter `status_id`, update `uk_aq_public.uk_aq_rpc_history_observations_upsert` and dependent writer code in the same change set.
