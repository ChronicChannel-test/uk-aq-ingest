...
alter table if exists services add column if not exists service_code text;
create unique index if not exists services_service_code_uidx on services(service_code);
