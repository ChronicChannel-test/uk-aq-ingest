...
begin
  for t in select unnest(array[
    'services','categories','phenomena','offerings','features','procedures','stations','timeseries','reference_values','observations','pm25_population_exposure','pm25_amct_sites','la_boundaries','pcon_boundaries','pcon_current','pcon_legacy','gss_codes','uk_aq_guidelines'
  ])
  loop
