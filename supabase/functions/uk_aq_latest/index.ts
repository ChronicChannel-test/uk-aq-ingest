...
async function loadLatest({ region, pconCode, stationLike, connectorId, pollutant, limit }: LoadOptions) {
  ...
  const stationSelect =
    "station:stations!timeseries_station_id_fkey(id,station_ref,label,station_name,region,la_code,la_version,pcon_code,pcon_version,connector_id,station_network_memberships(network_code,network_label,is_primary))";
  const stationSelectInner =
    "station:stations!timeseries_station_id_fkey!inner(id,station_ref,label,station_name,region,la_code,la_version,pcon_code,pcon_version,connector_id,station_network_memberships(network_code,network_label,is_primary))";
  const selectBase =
