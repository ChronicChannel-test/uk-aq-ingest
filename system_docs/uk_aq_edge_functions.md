...
- `OBS_AQIDB_SUPABASE_URL` (required for `uk_aq_timeseries` recent-window obs_aqidb reads)
- `OBS_AQIDB_SECRET_KEY` (required for `uk_aq_timeseries` recent-window obs_aqidb reads)
