...
- Shared-budget limit warnings (`shared_budget_minute_limit` / `shared_budget_hour_limit`) are retained in the normal OpenAQ connector log and are not mirrored to `/error_log/YYYY-MM-DD/`.
